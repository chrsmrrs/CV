...
Machine learning for graphs (graph neural networks, equivariant neural networks, graph kernels) from a theoretical as well as applied viewpoint, and their application in combinatorial optimization. 
\end{tabular}
...
\begin{tabular}{p{3.0cm}p{11.5cm}}
	starting 06/2021& Postdoctoral researcher at Mila Quebec AI Institute, Montréal\\
...
\emph{Boosting GNNs with Graph Reconstruction}, 2021. Submitted to International Conference of Machine Learning.
...
\begin{tabular}{l}
	Prof.~Petra Mutzel (main PhD supervisor)\\
