...
\years{2015--present} \emph{PhD Student/Research Associate}, TU Dortmund University, within the Collaborative Research Center SFB 876   (Expected graduation: End of 2019)\\
...
\emph{In submission} (\texttt{\url{https://arxiv.org/abs/1904.01543}})\\


Nils M.~Kriege,  Fredrik D. Johansson, Christopher Morris\\
\emph{A Survey on Graph Kernels},\\
\emph{In submission} (\texttt{\url{https://arxiv.org/abs/1903.11835}}),\\
...
\emph{In submission} (\texttt{\url{https://arxiv.org/abs/1703.00676}})\\
...
\years{7.2017} Talk at RWTH Aachen, Chair of Logic and the Theory of Discrete Systems, "Graph Classification: Kernels and Beyond"
...
Reviewer for ISAAC 2018, ESA 2018, WALCOM 2017, IJCAI 2019, NeurIPS  2019, ACM TKDD

Program committee member for "Representation Learning on Graphs and Manifolds" (ICLR 2019 Workshop)

Program committee member for "Learning and Reasoning with Graph-Structured Data" (ICML 2019 Workshop)
