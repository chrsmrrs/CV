...
B\l{}a\.z{}ej Banaszewski, Chad Martin, Dominic Masters.
	...
	\begin{longtabu}{p{2.1cm}p{12.0cm}}
		...
		11/2023 & LoG Paris Meetup, École Polytechnique, Inria \& CentraleSupélec, \emph{Weisfeiler and Leman go Machine Learning: Expressivity and Generalization Abilities of GNNs}\\    
	...
	Reviewer for the Swiss National Science Foundation (SNF) (1 $\times$ 2023), reviewer for the German Research Foundation (DFG) (1 $\times$ 2023)	\\[2em]	
		...
		Area chair for LoG Conference 2022 (Learning on Graphs Conference), Senior program committee member for AAAI 2023, Area chair for AAAI 2024, Area chair for LoG Conference 2023 (Learning on Graphs Conference) \\[3em]
