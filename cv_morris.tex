...
\subsubsection*{Conference Papers}
	\bibitem{Mor+2015}
	Pablo Barcelo, Mikhail Galkin, Christopher Morris, Miguel Romero Orth.{$^\dagger$}
	...
	\bibitem{Mor+2015}
	Elias B.\, Khalil\footnote{Equal contribution.}, Christopher Morris{\footnotesize$^*$}, Andrea Lodi.
	...
	\bibitem{Kri+2018}
	Nils M.~Kriege, Christopher Morris, Anja Rey, Christian Sohler.{$^\dagger$}
...
\bibitem{Mor+2020}
Martin Grohe, Stephan G\"{u}nnemann, Stefanie Jegelka, and Christopher Morris.
\emph{Graph Embeddings: Theory meets Practice (Dagstuhl Seminar 22132},
Dagstuhl Reports 12 (3), pages 2192--5283, 2022.
...
\bibitem{Mor+2020}
Nils M.~Kriege,  Fredrik D. Johansson, Christopher Morris..{$^\dagger$}
...
\bibitem{Mor+2019}
Martin Grohe, Stephan Günnemann, Stefanie Jegelka, Christopher Morris.
\emph{Graph Embeddings: Theory meets Practice (Dagstuhl Seminar 22132)},
...
\bibitem{Mor+2015}
Quentin Cappart, Didier Chételat, Elias Khalil, Andrea Lodi, Christopher Morris, Petar Veli\v{c}kovi\'{c}.{$^\dagger$}
\emph{Combinatorial optimization and reasoning with graph neural networks},
