...
\begin{tabular}{p{12.0cm}}
Co-organizer of the Dagsuhl seminar \emph{Graph Embeddings: Theory and Practice} (2021)\\[0.5em]
...
Program committee member for \emph{Representation Learning on Graphs and Manifolds} (ICLR 2019 Workshop), \emph{Learning and Reasoning with Graph-Structured Data} (ICML 2019 Workshop), \emph{Graph Representation Learning} (NeurIPS 2019 Workshop), \emph{Graph Representation Learning and Beyond} (ICML 2020 Workshop)\\[0.5em]
