...
\emph{Future Directions in the Theory of Graph Machine Learning},  International Conference on Machine Learning (ICML), 2024.
	...
	\begin{longtabu}{p{14.5cm}} 
	    ...
	    Reviewer for the Swiss National Science Foundation (SNF) (1 $\times$ 2023, 1 $\times$ 2024), reviewer for the German Research Foundation (DFG) (1$\times$2023, 1$\times$2024) \\[2.5em]
	...
	\begin{tabular}{p{14.5cm}}	
	Interview with the national newspaper Berliner Tagesspiegel on my research and being awarded the DFG Heinz Maier-Leibnitz-Preis \\		
