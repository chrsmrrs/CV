\documentclass[11pt, a4paper, DIV=14, headings=small]{scrartcl}
...
\begin{document}
	...
	\begin{tabular}{p{15.0cm}}
		Machine learning for graphs (graph neural networks, graph transformers, equivariant neural networks, graph kernels) from a theoretical as well as applied viewpoint, and its application in combinatorial optimization and the life and sciences.
	\end{tabular}
	...
	\begin{tabular}{p{3.0cm}p{11.5cm}}
		06/2022--present & Tenure-track assistant professor (``junior professorship'' (W1 $\to$ W2)) at RWTH Aachen, Department of Computer Science, mid-term evaluation sucessfully completed                                                                                                                                     \\
	...
	\begin{thebibliography}{15}
		...
		\emph{Covered Forest: Fine-grained generalization analysis of graph neural networks},
		...
		\emph{Position: Graph Learning Will Lose Relevance Due To Poor Benchmarks},
		International Conference on Machine Learning (ICML), 2025.
		...
		\emph{Position: Future Directions in the Theory of Graph Machine Learning},  International Conference on Machine Learning (ICML), 2024.
		...
		\emph{Cometh: A continuous-time discrete-state graph diffusion model}, Transaction on Machine Learning Research (TMLR), 2025.		
...
\begin{longtabu}{p{2.1cm}p{12.0cm}}
	03/2025--present & Solveig Wittig \\
	02/2025--present & Timo Stoll \\
...
\end{longtabu}
	...
	\begin{longtabu}{p{2.1cm}p{12.0cm}}
		2025& Berke Kisin, \emph{Gen-GPT: Autoregressive Molecule Generation with Generative Pretrained Transformers}, Master thesis, RWTH Aachen University \\	
		2024 & Wensheng Zhang, \emph{Exploration of the Influence of Graph Parameters on the Generalization Error of Graph Neural Networks}, Bachelor thesis, RWTH Aachen University \\	
	...
	\subsection*{Teaching}
	\begin{longtabu}{p{2.1cm}p{12.0cm}}
				SS 2025    & Master seminar \emph{Theory of Machine Learning on Graphs}          \\    
	& Master course \& exercise  \emph{Algorithmic Foundations of Data Science}                          \\              
			WS 2024    & Master seminar \emph{Transformers for Graphs}          \\    
& Bachelor proseminar \emph{Maschinelles Lernen mit Graphen}                          \\                                                    
	...
	\begin{longtabu}{p{14.5cm}} 
		Program committee chair for Learning on Graphs Conference (LoG) 2025\\
	    ...
	    Reviewer for the Isreali Science Foundation (ISF)  (1 $\times$ 2025), Reviewer for the Swiss National Science Foundation (SNSF) (1 $\times$ 2023, 1 $\times$ 2024), reviewer for the German Research Foundation (DFG) (1$\times$2023, 1$\times$2024, 1 $\times$ 2025) \\[2.5em]
		...
		Area chair for LoG Conference 2022 (Learning on Graphs Conference), Senior program committee member for AAAI 2023, Area chair for LoG Conference 2023 (Learning on Graphs Conference), Area chair for AAAI 2024, Area chair for NeurIPS 2024, Area chair for LoG Conference 2024 (Learning on Graphs Conference), Area chair for NeurIPS 2025 \\
		
		Program committee member for IJCAI 2019, NeurIPS  2019, AAAI 2020, ICML 2020, IJCAI 2020, ECML-PKDD 2020, NeurIPS 2020, ICLR 2021, AAAI 2021, ICML 2021, IJCAI 2021, NeurIPS 2021, ICLR 2022, ICML 2022, NeurIPS 2022 Competition Track, NeurIPS 2022, ICLR 2023, ICML 2023, NeurIPS 2023 (\emph{Top reviewer award}), NeurIPS 2023 Competition Track , NeurIPS 2023 Datasets and Benchmarks Track, ICLR 2024, ICML 2024, ICML 2025 \\
