\documentclass[10pt, a4paper, DIV=14, headings=small]{scrartcl}
...
\begin{tabular}{p{14.5cm}}
	...
	%Associated principal investigator of the DFG graduate school ``UnRAVeL -- UNcertainty and Randomness in Algorithms, VErification and Logic''  \\[1.5em]
