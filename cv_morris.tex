...
\emph{Combinatorial Optimization and Reasoning with Graph Neural Networks},
Journal of Machine Learning Research, 2023, extend version of [6].
...
\bibitem{Mor+2015}
Nico Piatkowski, Katharina Morik, Nils Kriege, Christopher Morris, Matthias Fey, Frank Weichert, Nico Bertram, Jonas Ellert, Johannes Fischer, Lukas Pfahler.
\emph{Structured Data}, in \emph{Volume 1 Fundamentals}, edited by Katharina Morik, Peter Marwedel, pages 179-193, in \emph{Machine Learning under Resource Constraints}, De Gruyter, 2023.
...
12/2023& Satellite Conference ``Deep Learning with Higher-Order Network Model'' at the International School
and Conference
on Network Science (NetSci) 2023, Vienna, \emph{TBD}\\	
05/2023& Dagstuhl workshop ``Scalable Graph Mining and Learning (23491)'', Dagstuhl, \emph{TBD}\\
...
& Bachelor Seminar \emph{Maschinelles Lernen mit Graphen}\\
...
\begin{tabular}{p{14.5cm}}
  IEEE Transactions on Mobile Computing (2020), Elsevier Signal Processing (2021)\\[0.5em]
\end{tabular}
\begin{tabular}{p{14.5cm}}
