...
\begin{document}
	...
	\begin{tabular}{p{15.0cm}}
		Machine learning for graphs (graph neural networks, graph transformers, equivariant neural networks, graph kernels) from a theoretical as well as applied viewpoint, and its application in combinatorial optimization and the life sciences.
	\end{tabular}
	...
	\begin{thebibliography}{15}
		...
		\emph{Provably Powerful Graph Transformers}, 2023.
		
		\bibitem{Mor+2015}
		Jan Böker, Ron Levie, Ningyuan Teresa Huang, Soledad Villar, Christopher Morris.
		\emph{Fine-grained Expressivity of Graph Neural Networks}, (Preprint: \texttt{arxiv:abs/2306.03698}), 2023.
		
		\bibitem{Mor+2015}
		Chendi Qian, Andrei Manolache, Kareem Ahmed, Zhe Zeng, Guy Van den Broeck, Mathias Niepert, Christopher Morris.
		\emph{Probabilistic Task-Adaptive Graph Rewiring}, 2023.
...
B\l{}a\.z{}ej Banaszewski, Chad Martin, Dominic Masters.
	...
	\begin{longtabu}{p{2.1cm}p{12.0cm}}
		...
		2023 & Ilian F.\ Kurt, \emph{A Theoretical and Empirical Investigation into the Equivalence of Graph Neural Networks and the Weisfeiler--Leman Algorithm}, Bachelor thesis, co-supervision with Michael T.\ Schaub, RWTH Aachen University \\
	...
	Reviewer for the Swiss National Science Foundation (SNF) (1 $\times$ 2023), reviewer for the German Research Foundation (DFG) (1 $\times$ 2023)	\\[2em]	
		...
		Area chair for LoG Conference 2022 (Learning on Graphs Conference), Senior program committee member for AAAI 2023, Senior program committee member for AAAI 2024, Area chair for LoG Conference 2023 (Learning on Graphs Conference) \\[3em]
		
		Program committee member for IJCAI 2019, NeurIPS  2019, AAAI 2020, ICML 2020, IJCAI 2020, ECML-PKDD 2020, NeurIPS 2020, ICLR 2021, AAAI 2021, ICML 2021, IJCAI 2021, NeurIPS 2021, ICLR 2022, ICML 2022, NeurIPS 2022 Competition Track, NeurIPS 2022, ICLR 2023, ICML 2023, NeurIPS 2023, NeurIPS 2023 Competition Track, NeurIPS 2023 Datasets and Benchmarks Track, ICLR 2024 \\[5.em]
	...
	\begin{tabular}{p{14.5cm}}
		...
		Associated principal investigator of the Helmholtz School for Data Science in Life, Earth and Energy (HDS-LEE) graduate school (1.5 PhD years) \\[1.5em]
	...
	\begin{tabular}{p{14.5cm}}
		Interview with the daily newspaper Aachener Zeitung on my research and starting a new group at RWTH Aachen University \\[0.5em]	
