...
\begin{document}
	...
	\begin{longtabu}{p{2.1cm}p{12.0cm}}
	     03/2024 & DFG Research Unit ADYN seminar (virtual), University of Frankfurt, \emph{WL meet VC: Generalization abilities of graph neural networks" by Christopher Morris}\\ 
	...
	\subsection*{Supervised Bachelor and Master students (first supervisor only)}
	\begin{longtabu}{p{2.1cm}p{12.0cm}}
	...
	\begin{tabular}{p{14.5cm}}
	Interview with the daily newspaper Der Tagesspiegel on my research and being awarded the DFG Heinz Maier-Leibnitz-Preis \\		
